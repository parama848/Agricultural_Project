...
const NewsLetterBox = () => {
  ...
  return (
    <div className='text-center '>
      ...
      <form onSubmit={onSubmitHandler} className='w-full sm:w-1/2 flex items-center gap-3 mx-auto my-6 border border-green-300 pl-3'>
        <input name='email' type="email"  placeholder='Enter your email' className='w-full sm:flex-1 outline-none  ' />
        <button type='submit' className='bg-green-400  text-white px-10 py-4 border border-green-400'>SUBSCRIBE</button>
      </form>
    </div>
  )
}
